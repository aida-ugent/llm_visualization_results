...
# Run ID: 20250403_170903_producer_prices_hard, Iteration: 11
...
# Select categories that are likely main categories or important subcategories
# We'll use a combination of pattern matching and manual selection
selected_categories = [
...
# Filter to include only these selected categories
df_selected = df_filtered[df_filtered['ProductsAccordingToPRODCOMList'].isin(selected_categories)]
