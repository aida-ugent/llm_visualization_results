...
# Run ID: 20250403_165639_consumer_prices_medium, Iteration: 6
...
start_increase = filtered_df[filtered_df['Date'] >= '2021-01-01'].iloc[0]
...
ax.text(filtered_df['Date'].min(), 100.5, 'Base Reference (100)', 
