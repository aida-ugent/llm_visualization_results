...
# Run ID: 20250403_165156_caribbean_births_medium, Iteration: 9
...
for i, row in plot_data.iterrows():
    # Calculate the position for the total label (below the x-axis label)
    plt.text(i, -10, f'Total: {row["Total"]:.0f}', ha='center', fontsize=12, fontweight='bold')
