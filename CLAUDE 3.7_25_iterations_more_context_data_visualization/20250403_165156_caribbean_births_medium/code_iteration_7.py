...
# Run ID: 20250403_165156_caribbean_births_medium, Iteration: 7
...
for i, row in plot_data.iterrows():
    region_idx = list(plot_data['Region']).index(row['Region'])
    boys = row['Boys']
    girls = row['Girls']
    total = boys + girls
    plt.text(region_idx, 5, f'Total: {total:.0f}', ha='center', fontsize=12, fontweight='bold')
