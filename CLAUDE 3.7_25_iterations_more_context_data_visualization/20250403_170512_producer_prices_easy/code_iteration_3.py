...
# Run ID: 20250403_170512_producer_prices_easy, Iteration: 3
...
product_categories = df['ProductsAccordingToPRODCOMList'].unique()

# Select a subset of interesting product categories (to avoid overcrowding the plot)
# Choose categories that might show different trends
selected_categories = [
...
filtered_df = df[
    (df['ProductsAccordingToPRODCOMList'].isin(selected_categories)) & 
    (df['OutputAndImportPrices'] == 'Total sales')
]
