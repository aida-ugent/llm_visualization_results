...
# Run ID: 20250403_170248_consumer_prices_hard, Iteration: 3
...
all_items_df['Date'] = pd.to_datetime(all_items_df[['Year', 'Month_Num']].assign(Day=1))
...
# Show the plot (not needed for saving, but useful for debugging)
plt.close()